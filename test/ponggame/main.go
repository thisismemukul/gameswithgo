...
//go:embed assets/spaceranger.ttf
var fontData []byte

//go:embed assets/icon_black.png
...
func loadIconImager() image.Image {
...
func main() {
	...
	game := &Game{
		...
		GameBall:      gameBall,
		FontFace:      loadFontFacer(),
		SelectedLevel: "",
	}

	ebiten.SetWindowTitle("Ultimate Pong!")
	ebiten.SetWindowSize(config.WindowWidth, config.WindowHeight)
	ebiten.SetWindowIcon([]image.Image{loadIconImager()})
